        ...
        <div class="main-products">
            ...
            <div class="social-share">
                <div class="social-wrapper">
                    ...
                    <a href="#"><i class="fab fa-viber"></i> share</a>
                    <a href="#"><i class="bx bxl-whatsapp"></i> share</a>
                    <a href="{{route('front.details.image_download', ['id' => $id])}}"><i class="fas fa-download"></i>Download all images</a>
                </div>
