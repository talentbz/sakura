                                ...
                                <div class="row">
                                    <div class="mb-3 row">
                                        <div class="mb-5">
                                            ...
                                            <textarea required class="form-control" rows="5" name="url" placeholder="youtube embed url">{{$video->url}}</textarea>
                                        </div>
                                        <div class="">
                                            <label class="form-label">Search Key</label>
                                            <input type="text" class="form-control"  placeholder="search key" name="search_key" value="{{$video->search_key}}" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script>
        var edit_url = "{{route('admin.video.edit_post')}}"
        var list_url = "{{route('admin.video.index')}}"
    </script>
    <script src="{{ URL::asset('/assets/libs/parsleyjs/parsleyjs.min.js') }}"></script>
    <script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    <script src="{{ URL::asset('/assets/admin/pages/video/edit.js') }}"></script>
@endsection