...
@section('title') Add Maker type @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Add Maker Type @endslot
    @endcomponent
    <div class="row">
                        ...
                        <form id="myForm" class="custom-validation">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" name="maker_type" required />
                                </div>
...
@section('script')
    <script>
        var add_url = "{{route('admin.makerType.add_post')}}"
        var list_url = "{{route('admin.makerType.index')}}"
    </script>
    
    <script src="{{ URL::asset('/assets/admin/pages/makerType/add.js') }}"></script>
@endsection
