...
@section('title') Maker type @endsection

@section('content')
    @component('components.breadcrumb')
        @slot('li_1') Category @endslot
        @slot('title') Maker Type @endslot
    @endcomponent
    <div class="row">
        <div class="col-12">
            <div class="card">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    @if($row->image)
                                        <img src="{{URL::asset('/uploads/maker_type')}}{{'/'}}{{$row->image}}" width='30' alt="">   
                                    @endif
                                </td>
                                <td align="center">{{$row->maker_type}}</td>
                                <td align="center">{{date("Y-m-d", strtotime($row->created_at))}}</td>
                                <td align="center">
                                    <a href="{{route('admin.makerType.edit', ['id' => $row->id])}}" class="text-success edit" ><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myModalLabel">Maker Type Delete</h5>
...
@section('script')
    <!-- apexcharts -->
    <script>
        var delete_url = "{{route('admin.makerType.delete')}}"
        var list_url = "{{route('admin.makerType.index')}}"
    </script>
    
    <script src="{{ URL::asset('/assets/admin/pages/makerType/index.js') }}"></script>
@endsection
